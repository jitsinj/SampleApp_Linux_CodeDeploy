...
resume_processes() {
  ...
  msg "Resume process on Autoscaling Group for deployment group name:  $DEPLOYMENT_GROUP_NAME"
  ...
  msg "Resuming ${processes[*]} processes over autoScalingGroup $asg_name"
